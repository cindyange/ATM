// var array = [2, 5, 8, 7, 6, 0, 6, 4, 8, 7, 8];
...
btnDeposit.addEventListener('click', () => {
    ...
    if (isNaN(userDeposit.value)|| userDeposit.value === "") {
        alert("Please enter a number.");
        return userDeposit.value = '';
    } else {

    // checks if deposit meets parameters
        if (userDeposit.value < 0.1 || userDeposit.value > 100000000000000000) {
            alert("You can only deposit between 100$ and $100000000000000000.")
            return userDeposit.value = '';
        }
        else {
    ...
    console.log("user deposited $" + userDeposit.value);
    return userDeposit.value = '';
    }
}
...
btnWithdraw.addEventListener('click', () => {
    ...
    console.log("user withdrew $" + userWithdraw.value);
    return userWithdraw.value = '';
    }
}
});
